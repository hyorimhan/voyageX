  ...
  return (
    <AccordionItem
      header={({ state: { isEnter } }) => (
        <div className='flex'>
          <div className='text-2xl font-semibold'>필수 훈련 과정</div>
    ...
    >
      ...
      <ul className='mt-6'>
        ...
        <li className='mb-4'>
          <strong>▪︎ 우주선 및 장비 사용 훈련</strong>
          <ul className='mt-2'>
            <li>
              우주선 조작 훈련: 기본적인 우주선 조작 방법 및 비상 상황 대처 방법
            </li>
            <li>우주복 착용 및 사용 훈련: 우주복 착용 방법 및 사용법 익히기</li>
            <li>
              생명 유지 시스템 훈련: 우주선의 생명 유지 장치 사용법과 유지관리
              방법
            </li>
          </ul>
        </li>
        <li className='mb-4'>
          <strong>▪︎ 응급 상황 대처 훈련</strong>
          <ul className='mt-2'>
            <li>응급 의료 훈련: 우주에서 발생할 수 있는 응급 상황 대처법 </li>
            <li>
              화재 및 압력 손실 대처 훈련: 우주선 내 화재 발생 시와 압력 손실
              상황 시 대처법
            </li>
        ...
        <li className='mb-4'>
          <strong>▪︎ 심리적 안정 훈련</strong>
          <ul className='mt-2'>
            <li>
              스트레스 관리 훈련: 장기간의 우주 여행에서 발생할 수 있는 스트레스
              관리 방법
            </li>
            <li>
