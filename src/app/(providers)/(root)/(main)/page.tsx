...
>
  <h1
    className={`text-4xl absolute font-semibold top-40 left-60 ${orbitron.className}
    sm:text-2xl sm:font-medium sm:top-16 sm:left-4`}
  >
    GOODS SHOP
  </h1>
  <Link href='/shop'>
    <p className='absolute top-48 right-20 underline sm:top-16 sm:right-4'>MORE+</p>
  </Link>
  ...
  {goodsLoading ? (
    ...
    <div className='grid grid-cols-3 gap-4 sm:grid-cols-2 sm:gap-2'>
        ...
        >
          <Link href={`shop_detail/${item.id}`}>
            <Image
              ...
              width={320}
              height={360}
              className='object-cover sm:w-40 sm:h-32'
            />
