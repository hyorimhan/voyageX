...
export default async function GoodsSection() {
  ...
  return (
    <section className='section section-bg h-screen flex flex-col items-center justify-center transition-opacity duration-500'>
      <h1
    ...
    sm:text-2xl sm:font-medium sm:top-16 sm:left-4`}
      ...
      <Link href='/shop'>
        <p className={`absolute top-48 right-20 underline transition-opacity duration-500 opacity-100 sm:top-16 sm:right-4`}>
          MORE+
        </p>
      </Link>
